...
<head>
<meta charset="utf-8">
<title>Diabless / <?php echo $title;?></title>
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<meta name="description" content="" />
<meta name="author" content="http://webthemez.com" />
<!-- css -->
<link href="http://localhost/jobseek/plugins/home-plugins/css/bootstrap.min.css" rel="stylesheet" />
            ...
            <div class="row">
              <div class="col-md-12">
                <?php if (isset($_SESSION['APPLICANTID'])) { 
                    ...
                    <i class="fa fa-user"></i> Hello, '. $appl->FNAME. ' '.$appl->LNAME .' </a> |
                    <a href="'.web_root.'logout.php">  <i class="fa fa-sign-out"> </i>Logout</a> </p>';

                    }else{ ?>
                      <p   class="pull-right login"><a data-target="#myModal" data-toggle="modal" href="">
                        <i class="fa fa-lock"></i> Login </a></p>
                <?php } ?>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">Diabless<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          <h5 class="widgetheading">Our Group</h5>
          <strong>Diabless</strong><br>
          Barredo, Khursten<br>
          De Guzman, Karlo<br>
          Flameno, Cymon<br>
          Lozada, Emar<br>
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <ul class="social-network">
            ...
            <li><a href="https://instagram.com" data-placement="top" title="Linkedin"><i class="fa fa-instagram"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
