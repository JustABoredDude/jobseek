...
$isStaff = ($_SESSION['ADMIN_ROLE'] === 'Staff');
?> 
...
<form action="controller.php?action=approve" method="POST">
    ...
    <div class="col-sm-6 content-body"> 
        ...
        <div class="col-sm-6">
            <ul>
                <li>Required No. of Employee's: <?php echo $job->REQ_NO_EMPLOYEES; ?></li>
                <li>Salary: <?php echo number_format($job->SALARIES, 2); ?></li>
                <li>Duration of Employment: <?php echo $job->DURATION_EMPLOYEMENT; ?></li>
            </ul>
        </div>
        <div class="col-sm-6">
            <ul>
                <li>Preferred Sex: <?php echo $job->PREFEREDSEX; ?></li>
                <li>Sector of Vacancy: <?php echo $job->SECTOR_VACANCY; ?></li>
            </ul>
        </div>
        <div class="col-sm-12">
            <p>Job Description:</p>   
    ...
    <div class="col-sm-12 content-footer">
        ...
        <div class="col-sm-12">
            <p>Feedback</p>
            <textarea class="input-group" name="REMARKS" <?php echo $isStaff ? 'disabled' : ''; ?>>
                <?php echo isset($jobreg->REMARKS) ? $jobreg->REMARKS : ""; ?>
            </textarea>
        </div>

        <div class="col-sm-12 submitbutton"> 
            <button type="submit" name="submit" class="btn btn-primary" <?php echo $isStaff ? 'disabled' : ''; ?>>Send</button>
        </div> 
    </div>
</form>
